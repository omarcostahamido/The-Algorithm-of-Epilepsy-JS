...
seizure_bursts_onset_timing=[50]
seizure_burst_shapes=[[40,35],[80,30],[79,17],[50,50]]
seizure_prob_onset_neurons=[0.1, 0.12333333, 0.14666667, 0.17, 0.19333333, 0.21666667, 0.24, 0.26333333, 0.28666667, 0.31, 0.33333333, 0.35666667, 0.38, 0.40333333, 0.42666667, 0.45, 0.47333333, 0.49666667, 0.52, 0.54333333, 0.56666667, 0.59, 0.61333333, 0.63666667, 0.66, 0.68333333, 0.70666667, 0.73, 0.75333333, 0.77666667, 0.8]
seizure_burst_coordinates=[[125,125]]
...
function draw() {
  ...
  if (f>(n_iterations+10) && f<(n_iterations+70)) {
    ...
    ctx.fillText("execution_D", canvas.width/2, canvas.height/2);
  }
  f++;
